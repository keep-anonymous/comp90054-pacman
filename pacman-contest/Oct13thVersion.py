...
''' The author of attacking agentis XINJIE LAN and the author of defensive agent is LIUYI CHAI
    ...
    This version edited after eat capluse, pacman will first eat nearby ghost then eat food then go back to home
    Defence added astar when can't get to enemy when stuck
