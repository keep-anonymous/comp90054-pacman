...
class DefensiveReflexAgent(ReflexCaptureAgent):
    ...
    def getFeatures(self, gameState, action):
      ...
      if len(self.defendingFood)>len(myFood):
        ...
        self.defendingFood=myFood
        self.target=target
        index = 1 #mark this situation
        
      #when enemy lose pacdots
      if len(self.defendingFood)< len(myFood):
        print "renew the defendingfood"
        self.defendingFood = myFood
      ...
      if len(invaders) == 0:
        ...
        if len(nearOpponents) > 0 and index == 0:
          print "stick to the opponent!"
          ...
          print "patrol to food or border"
      else:
    ...
    def getWeights(self, gameState, action):
      return { 'onDefense': 100, 'behindBorderLine':50, 'invaderDist': -10, 'nearDist':-10, 'opponentDist':-10, 'reverse': -10,
