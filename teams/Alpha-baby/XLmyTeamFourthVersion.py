...
''' Author is Xinjie Lan
    this is the fourth version for offensive agent using approximate Q learning technique
    This version added the feature that when pacman eats the cap, the pacman will attach the scared ghost who is within the range.
