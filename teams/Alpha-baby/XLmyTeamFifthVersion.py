...
''' Author is Xinjie Lan
    this is the fifth version for offensive agent using approximate Q learning technique
    After watched the replay, I found that when the map is different, the feature I defined in previous version is not working
    due to the size of food list. This version fixed the issue by normalize the length of list by using
    the food I want to take dividing total food.

    reward is tested against differnt values. still needs some work

    
    there are some future works 
                                1 escape route needs to be smarter, pacman can't just simply go back to the cloesest base.
