...
''' Author is Xinjie Lan
    This is the 11th version for offensive agent using approximate Q learning technique.
    This version didn't change much, aStar is implemented when equliburim state happend but not in this file.
    AstarSearch will be tested on 10/10
