...
''' Author is Xinjie Lan
    This is the seventh version for offensive agent using approximate Q learning technique.
    After watched the replay, I found that the when my pacman got the capluse, it will chase the ghost till
    the end of scared time. This version fixed this issue by setting detect scared time >10.
    Also, this version edit the strategic that when there are only two dots left, my pacman will avoid the ghosts.
